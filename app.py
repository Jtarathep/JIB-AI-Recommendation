...
<style>
    ...
    .kk-hero {
        ...
        border-radius: 22px;
        background: radial-gradient(circle at 88% 20%, rgba(67,97,238,.18), transparent 35%),
                    radial-gradient(circle at 10% 80%, rgba(0,200,180,.10), transparent 35%),
                    linear-gradient(135deg, rgba(10,22,45,.98), rgba(13,18,32,.98));
    ...
    .kk-title {
        ...
        line-height: 1.05;
        margin: 0;
        background: linear-gradient(90deg, #ffffff 0%, #8eb6ff 52%, #b98cff 100%);
    ...
    .kk-subtitle strong { color: #ffffff; }
    ...
    .kk-badge {
        ...
        padding: .72rem .78rem;
        border-radius: 14px;
        border: 1px solid rgba(130,160,220,.22);
        background: linear-gradient(145deg, rgba(35,55,95,.72), rgba(20,29,50,.78));
        color: #eef5ff;
        font-size: .82rem;
        font-weight: 700;
        display: flex;
    ...
    @media (max-width: 760px) {
        ...
        .kk-flow { grid-template-columns: repeat(2, minmax(0, 1fr)); }
        .kk-badges { grid-template-columns: repeat(2, minmax(0, 1fr)); }
    }
</style>
...
<div class="kk-hero">
  ...
  <div class="kk-badges">
    <div class="kk-badge">🧠 AI Recommendation<span>วิเคราะห์ความต้องการและแนะนำชุดคอม</span></div>
    <div class="kk-badge">⚙️ Machine Learning<span>ใช้โมเดล ML ช่วยจัดอันดับผลลัพธ์</span></div>
    <div class="kk-badge">🛡️ PC Compatibility<span>ตรวจสอบความเข้ากันได้ของอุปกรณ์</span></div>
    <div class="kk-badge">📊 JIB Case Study<span>กรณีศึกษาการแนะนำสินค้า PC</span></div>
  </div>
</div>

<div class="kk-flow">
  <div class="kk-step"><strong>1 · Requirement</strong>งบ + การใช้งาน</div>
  <div class="kk-step"><strong>2 · AI Analysis</strong>วิเคราะห์และจัดอันดับ</div>
  <div class="kk-step"><strong>3 · PC Builds</strong>Build 1 / 2 / 3</div>
  <div class="kk-step"><strong>4 · Compatibility</strong>ตรวจสอบความเข้ากันได้</div>
</div>
...
with st.sidebar:
    ...
    st.caption("JIB AI Recommendation System")
    st.divider()
