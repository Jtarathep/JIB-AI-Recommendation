...
/* The real checkbox is a transparent full-size hit area. This prevents
   Streamlit layers / the label's text box from stealing the click. */
#kk-theme-toggle {
    position:absolute;
    inset:0;
    width:100%;
...
/* ===== System-aware theme ===== */
/* Browser/OS light: unchecked = light, checked = dark. */
...
/* Browser/OS dark: unchecked = dark, checked = light. */
@media (prefers-color-scheme: dark) {
/* ===== Light theme override ===== */
body:has(#kk-theme-toggle:checked) .stApp{background:#f5f7fb;}
body:has(#kk-theme-toggle:checked) [data-testid="stAppViewContainer"],body:has(#kk-theme-toggle:checked) [data-testid="stMainBlockContainer"]{background:#f5f7fb;}
body:has(#kk-theme-toggle:checked) [data-testid="stSidebar"]{background:linear-gradient(180deg,#f8fbff 0%,#eef3fa 100%);border-right:1px solid #d7e0ed;}
body:has(#kk-theme-toggle:checked) [data-testid="stSidebar"] *{color:#263954;}
body:has(#kk-theme-toggle:checked) .kk-title{background:linear-gradient(90deg,#10234a 0%,#1766b8 48%,#6547c7 100%);-webkit-background-clip:text;background-clip:text;color:transparent;}
body:has(#kk-theme-toggle:checked) .kk-subtitle{color:#40516d;}
body:has(#kk-theme-toggle:checked) .kk-subtitle strong{color:#182844;}
body:has(#kk-theme-toggle:checked) .kk-badge{color:#15233c;background:linear-gradient(145deg,#ffffff,#edf3ff);border-color:#c9d7ef;box-shadow:0 8px 22px rgba(47,72,120,.10),inset 0 1px 0 #fff;}
body:has(#kk-theme-toggle:checked) .kk-badge span{color:#5c6d87;}
body:has(#kk-theme-toggle:checked) .kk-step{color:#53637b;background:linear-gradient(145deg,#f8fbff,#edf3fb);border-color:#d3dff0;}
body:has(#kk-theme-toggle:checked) .kk-step strong{color:#172640;}
body:has(#kk-theme-toggle:checked) .kk-flow{background:#f5f8fd;border-color:#d7e1ef;}
body:has(#kk-theme-toggle:checked) .kk-note{color:#52627b;background:linear-gradient(90deg,#effaf8,#f2f4ff);border-color:#b8dcd6;}
body:has(#kk-theme-toggle:checked) .kk-note b{color:#172640;}
body:has(#kk-theme-toggle:checked) .kk-edit-heading,body:has(#kk-theme-toggle:checked) .kk-candidate-title,body:has(#kk-theme-toggle:checked) .kk-preview-title b{color:#182844;}
body:has(#kk-theme-toggle:checked) .kk-edit-sub,body:has(#kk-theme-toggle:checked) .kk-preview-title small{color:#66758d;}
body:has(#kk-theme-toggle:checked) .kk-preview-title{background:linear-gradient(135deg,#f4f7ff,#ffffff);border-color:#d3deef;}
body:has(#kk-theme-toggle:checked) .kk-side-brand .brand{color:#172640;}
body:has(#kk-theme-toggle:checked) .kk-side-card{background:linear-gradient(145deg,#ffffff,#f1f5fb);border-color:#d6e0ee;color:#263954;}
body:has(#kk-theme-toggle:checked) .kk-side-label{color:#70809a;}
body:has(#kk-theme-toggle:checked) [data-testid="stChatMessage"]{background:linear-gradient(145deg,#ffffff,#f3f7fd);border-color:#cfdaeb;box-shadow:0 10px 28px rgba(42,63,100,.09),inset 0 1px 0 #fff;}
body:has(#kk-theme-toggle:checked) [data-testid="stChatMessage"] [data-testid="stMarkdownContainer"]{color:#1d2b42;}
body:has(#kk-theme-toggle:checked) .kk-user-bubble{color:#13223d;background:linear-gradient(135deg,#e7e9ff,#e4f0ff);border-color:#b8c8ec;box-shadow:0 8px 24px rgba(66,87,150,.10),inset 0 1px 0 #fff;}
body:has(#kk-theme-toggle:checked) [data-testid="stChatInput"]{background:linear-gradient(135deg,#ffffff,#f0f4fb) !important;border-color:#9fb5df !important;box-shadow:0 0 0 1px rgba(63,102,190,.06),0 10px 28px rgba(45,65,105,.12) !important;}
body:has(#kk-theme-toggle:checked) [data-testid="stChatInput"] textarea{color:#172640 !important;}
body:has(#kk-theme-toggle:checked) [data-testid="stChatInput"] textarea::placeholder{color:#7586a0 !important;}
body:has(#kk-theme-toggle:checked) .stButton>button{color:#1c2c47 !important;background:linear-gradient(145deg,#ffffff,#eef3fa) !important;border-color:#c4d1e5 !important;box-shadow:inset 0 1px 0 #fff,0 4px 14px rgba(48,68,105,.06) !important;}
body:has(#kk-theme-toggle:checked) .stButton>button:hover{background:linear-gradient(145deg,#f7faff,#e8effa) !important;border-color:#6f94d4 !important;box-shadow:0 8px 22px rgba(56,91,158,.12) !important;}
body:has(#kk-theme-toggle:checked) [data-testid="stExpander"]{background:#ffffff !important;border-color:#d5dfed !important;}
body:has(#kk-theme-toggle:checked) [data-testid="stExpander"] summary{color:#20324f !important;}
body:has(#kk-theme-toggle:checked) [data-testid="stAlert"]{background:#f5f8fd !important;color:#263954 !important;border-color:#d2ddec !important;}
body:has(#kk-theme-toggle:checked) [data-testid="stAlert"] p,body:has(#kk-theme-toggle:checked) [data-testid="stAlert"] div{color:#263954 !important;}
body:has(#kk-theme-toggle:checked) .stMarkdown,body:has(#kk-theme-toggle:checked) .stCaption,body:has(#kk-theme-toggle:checked) label,body:has(#kk-theme-toggle:checked) [data-testid="stMetricLabel"],body:has(#kk-theme-toggle:checked) [data-testid="stMetricValue"]{color:#243650;}
body:has(#kk-theme-toggle:checked) a{color:#2469c8 !important;}
body:has(#kk-theme-toggle:checked) h1,body:has(#kk-theme-toggle:checked) h2,body:has(#kk-theme-toggle:checked) h3,body:has(#kk-theme-toggle:checked) h4,body:has(#kk-theme-toggle:checked) h5,body:has(#kk-theme-toggle:checked) h6{color:#172640;}
body:has(#kk-theme-toggle:checked) [data-testid="stTextInput"] input,body:has(#kk-theme-toggle:checked) textarea,body:has(#kk-theme-toggle:checked) select{color:#172640 !important;}
/* Strong, readable light theme */
body:has(#kk-theme-toggle:checked) {background:#f4f7fb !important;}
body:has(#kk-theme-toggle:checked) .stApp,body:has(#kk-theme-toggle:checked) [data-testid="stAppViewContainer"],body:has(#kk-theme-toggle:checked) [data-testid="stMainBlockContainer"] {background:#f4f7fb !important;}
body:has(#kk-theme-toggle:checked) .kk-hero {background:radial-gradient(circle at 86% 18%,rgba(119,72,255,.13),transparent 28%),radial-gradient(circle at 70% 92%,rgba(0,170,255,.10),transparent 30%),linear-gradient(135deg,#eef7ff 0%,#f3f2ff 55%,#f8f5ff 100%);border-color:#c8d8f0;box-shadow:0 18px 48px rgba(49,72,112,.12),inset 0 1px 0 #fff;}
body:has(#kk-theme-toggle:checked) .kk-eyebrow {color:#1768c7;}
body:has(#kk-theme-toggle:checked) .kk-title {background:linear-gradient(90deg,#102c61 0%,#1766b8 48%,#6547c7 100%);-webkit-background-clip:text;background-clip:text;color:transparent;}
body:has(#kk-theme-toggle:checked) .kk-subtitle {color:#304664;} body:has(#kk-theme-toggle:checked) .kk-subtitle strong {color:#102b55;}
body:has(#kk-theme-toggle:checked) .kk-badge {background:linear-gradient(145deg,#ffffff,#edf4ff);color:#152844;border-color:#c9d8ee;box-shadow:inset 0 1px 0 #fff,0 8px 24px rgba(54,78,120,.08);} body:has(#kk-theme-toggle:checked) .kk-badge span {color:#536782;}
body:has(#kk-theme-toggle:checked) .kk-flow {background:rgba(255,255,255,.78);border-color:#cfdceb;box-shadow:0 8px 24px rgba(54,78,120,.06);} body:has(#kk-theme-toggle:checked) .kk-step {background:linear-gradient(145deg,#ffffff,#f0f5fc);color:#52637c;border-color:#cfdbeb;} body:has(#kk-theme-toggle:checked) .kk-step strong {color:#152844;}
body:has(#kk-theme-toggle:checked) .kk-note {color:#344a68;background:linear-gradient(90deg,#effaf8,#f2f5ff);border-color:#b9d8d5;} body:has(#kk-theme-toggle:checked) .kk-note b {color:#122947;}
body:has(#kk-theme-toggle:checked) [data-testid="stChatMessage"] {background:linear-gradient(145deg,#ffffff,#f2f6fc);border-color:#cbd9ea;box-shadow:0 10px 28px rgba(42,63,100,.08),inset 0 1px 0 #fff;}
body:has(#kk-theme-toggle:checked) [data-testid="stChatMessage"] [data-testid="stMarkdownContainer"],body:has(#kk-theme-toggle:checked) [data-testid="stChatMessage"] p,body:has(#kk-theme-toggle:checked) [data-testid="stChatMessage"] li,body:has(#kk-theme-toggle:checked) [data-testid="stChatMessage"] strong {color:#172942 !important;}
body:has(#kk-theme-toggle:checked) .kk-user-bubble {color:#122542 !important;background:linear-gradient(135deg,#e7edff,#e9f5ff);border-color:#b9cbea;box-shadow:0 8px 24px rgba(66,87,150,.09),inset 0 1px 0 #fff;}
body:has(#kk-theme-toggle:checked) [data-testid="stChatInput"] {background:linear-gradient(135deg,#ffffff,#eef4fc) !important;border-color:#9fb8df !important;box-shadow:0 8px 26px rgba(45,65,105,.12) !important;} body:has(#kk-theme-toggle:checked) [data-testid="stChatInput"] textarea {color:#122542 !important;-webkit-text-fill-color:#122542 !important;} body:has(#kk-theme-toggle:checked) [data-testid="stChatInput"] textarea::placeholder {color:#6d809d !important;}
body:has(#kk-theme-toggle:checked) [data-testid="stBottomBlockContainer"],body:has(#kk-theme-toggle:checked) [data-testid="stBottom"],body:has(#kk-theme-toggle:checked) section[data-testid="stChatInput"],body:has(#kk-theme-toggle:checked) .stChatFloatingInputContainer,body:has(#kk-theme-toggle:checked) [data-testid="stBottomBlockContainer"] > div,body:has(#kk-theme-toggle:checked) [data-testid="stBottom"] > div,body:has(#kk-theme-toggle:checked) section[data-testid="stChatInput"] > div,body:has(#kk-theme-toggle:checked) .stChatFloatingInputContainer > div,body:has(#kk-theme-toggle:checked) [data-testid="stChatInput"] > div {background:#f4f7fb !important;}
body:has(#kk-theme-toggle:checked) [data-testid="stChatInput"] [data-baseweb="textarea"],body:has(#kk-theme-toggle:checked) [data-testid="stChatInput"] [data-baseweb="base-input"],body:has(#kk-theme-toggle:checked) [data-testid="stChatInput"] [data-testid="stChatInputTextArea"] {background:transparent !important;color:#122542 !important;}
body:has(#kk-theme-toggle:checked) [data-testid="stChatInput"] button {background:linear-gradient(135deg,#6b4cff,#7b4dff) !important;color:#fff !important;border-color:#a99cff !important;box-shadow:0 5px 16px rgba(90,70,230,.22) !important;}
body:has(#kk-theme-toggle:checked) .stButton > button {color:#162943 !important;background:linear-gradient(145deg,#ffffff,#eef4fb) !important;border-color:#bfd0e5 !important;box-shadow:inset 0 1px 0 #fff,0 4px 14px rgba(48,68,105,.06) !important;} body:has(#kk-theme-toggle:checked) .stButton > button:hover {color:#102542 !important;background:linear-gradient(145deg,#ffffff,#e7f0fb) !important;border-color:#6d94d4 !important;}
body:has(#kk-theme-toggle:checked) [data-testid="stMarkdownContainer"],body:has(#kk-theme-toggle:checked) .stMarkdown,body:has(#kk-theme-toggle:checked) .stCaption,body:has(#kk-theme-toggle:checked) label,body:has(#kk-theme-toggle:checked) [data-testid="stMetricLabel"],body:has(#kk-theme-toggle:checked) [data-testid="stMetricValue"] {color:#203653 !important;}
body:has(#kk-theme-toggle:checked) [data-testid="stMarkdownContainer"] p,body:has(#kk-theme-toggle:checked) [data-testid="stMarkdownContainer"] li,body:has(#kk-theme-toggle:checked) [data-testid="stMarkdownContainer"] span,body:has(#kk-theme-toggle:checked) [data-testid="stMarkdownContainer"] div {color:#203653;}
body:has(#kk-theme-toggle:checked) h1,body:has(#kk-theme-toggle:checked) h2,body:has(#kk-theme-toggle:checked) h3,body:has(#kk-theme-toggle:checked) h4,body:has(#kk-theme-toggle:checked) h5,body:has(#kk-theme-toggle:checked) h6 {color:#142742 !important;} body:has(#kk-theme-toggle:checked) a {color:#1767c5 !important;}
body:has(#kk-theme-toggle:checked) [data-testid="stAlert"],body:has(#kk-theme-toggle:checked) [data-testid="stAlert"] p,body:has(#kk-theme-toggle:checked) [data-testid="stAlert"] div {color:#203653 !important;}
body:has(#kk-theme-toggle:checked) [data-testid="stExpander"] {background:#ffffff !important;border-color:#d1ddeb !important;color:#203653 !important;} body:has(#kk-theme-toggle:checked) [data-testid="stExpander"] summary {color:#203653 !important;}
body:has(#kk-theme-toggle:checked) .kk-edit-heading,body:has(#kk-theme-toggle:checked) .kk-candidate-title,body:has(#kk-theme-toggle:checked) .kk-preview-title b {color:#142742 !important;} body:has(#kk-theme-toggle:checked) .kk-edit-sub,body:has(#kk-theme-toggle:checked) .kk-preview-title small {color:#60738f !important;} body:has(#kk-theme-toggle:checked) .kk-preview-title {background:linear-gradient(135deg,#f4f7ff,#ffffff);border-color:#cbd9ea;}
body:has(#kk-theme-toggle:checked) .kk-side-card {background:linear-gradient(145deg,#ffffff,#f0f5fb);border-color:#d3dfed;color:#263954;} body:has(#kk-theme-toggle:checked) .kk-side-brand .brand {color:#172640;} body:has(#kk-theme-toggle:checked) .kk-side-label {color:#6c7d97;}

}

/* The toggle label follows the same system-aware rule. */
@media (prefers-color-scheme: dark) {
  body:not(:has(#kk-theme-toggle:checked)) .kk-theme-icon-light,
  body:not(:has(#kk-theme-toggle:checked)) .kk-theme-text-light {display:none;}
  body:not(:has(#kk-theme-toggle:checked)) .kk-theme-icon-dark,
  body:not(:has(#kk-theme-toggle:checked)) .kk-theme-text-dark {display:inline;}
  body:has(#kk-theme-toggle:checked) .kk-theme-icon-light,
  body:has(#kk-theme-toggle:checked) .kk-theme-text-light {display:inline;}
  body:has(#kk-theme-toggle:checked) .kk-theme-icon-dark,
  body:has(#kk-theme-toggle:checked) .kk-theme-text-dark {display:none;}
  body:not(:has(#kk-theme-toggle:checked)) .kk-theme-switch {
    color:#f7f9ff;background:linear-gradient(135deg,#18294a,#232053);
    border:1px solid #667eea;box-shadow:0 8px 24px rgba(43,65,150,.28),0 0 20px rgba(90,76,255,.12);
  }
...
/* Keep the floating chat composer aligned with the active theme. */
@media (prefers-color-scheme: light) {
  body:not(:has(#kk-theme-toggle:checked)) [data-testid="stBottomBlockContainer"],
  body:not(:has(#kk-theme-toggle:checked)) [data-testid="stBottom"],
  body:not(:has(#kk-theme-toggle:checked)) section[data-testid="stChatInput"],
  body:not(:has(#kk-theme-toggle:checked)) .stChatFloatingInputContainer {background:#f4f7fb !important;}
  body:has(#kk-theme-toggle:checked) [data-testid="stBottomBlockContainer"],
  body:has(#kk-theme-toggle:checked) [data-testid="stBottom"],
  body:has(#kk-theme-toggle:checked) section[data-testid="stChatInput"],
  body:has(#kk-theme-toggle:checked) .stChatFloatingInputContainer {background:rgba(7,11,21,.96) !important;}
}
@media (prefers-color-scheme: dark) {
  body:not(:has(#kk-theme-toggle:checked)) [data-testid="stBottomBlockContainer"],
  body:not(:has(#kk-theme-toggle:checked)) [data-testid="stBottom"],
  body:not(:has(#kk-theme-toggle:checked)) section[data-testid="stChatInput"],
  body:not(:has(#kk-theme-toggle:checked)) .stChatFloatingInputContainer {background:rgba(7,11,21,.96) !important;}
  body:has(#kk-theme-toggle:checked) [data-testid="stBottomBlockContainer"],
  body:has(#kk-theme-toggle:checked) [data-testid="stBottom"],
  body:has(#kk-theme-toggle:checked) section[data-testid="stChatInput"],
  body:has(#kk-theme-toggle:checked) .stChatFloatingInputContainer {background:#f4f7fb !important;}
}
</style>
...
def build_start_command(text):
    """Recognize short commands that mean: start/build the current PC recommendation."""
    t = str(text or "").strip().lower()
    # Avoid treating component-edit commands as a build-start command.
    if _component_edit_command(t, "cpu") or _component_edit_command(t, "gpu") or _component_edit_command(t, "ram") or _component_edit_command(t, "storage"):
        return False
    phrases = [
        # Explicit build/start commands. These are intentionally short so a
        # user can simply say "จัด" or "ให้จัด" after asking for a budget.
        "เริ่มเลย", "สร้างเลย", "จัดเลย", "จัด", "ให้จัด", "ขอจัด", "จัดคอม",
        "จัดคอมเลย", "สร้างให้หน่อย", "จัดให้หน่อย", "ลุย", "ได้ครับ", "ได้เลย",
        "โอเค", "ok", "okay", "จัดมา", "เริ่ม", "สร้าง", "จัดให้",
        "go", "start", "build it", "let's go"
    ]
    return any(t == p or t.startswith(p + " ") for p in phrases)
...
def _candidate_probe(req, base_build, component, item_name):
    ...
    if component == "cpu":
        ...
        if item:
            # Keep the exact RAM model selected by the user. Capacity/DDR alone
            # are not unique in the Dataset because several kits share them.
            probe["_ram_model"] = item.get("name")
...
def _apply_component_to_build(req, base_build, component, item_name):
    ...
    chosen = result[0]
    actual = chosen.get("build", {}).get(component, {})
    if actual.get("name") != item_name:
        # Never silently accept a different component than the user's selected
        # model. Search a wider result set before declaring the edit invalid.
        wider = recommend_builds(probe, top_n=12)
        for candidate in wider:
            if candidate.get("build", {}).get(component, {}).get("name") == item_name:
                chosen = candidate
                break
        else:
            return None
...
if prompt:
    ...
    if budget_kind:
        result = estimate_min_budget() if budget_kind == "min" else estimate_high_budget_reference()
        reply = budget_question_reply(budget_kind)
        # Keep the discovered budget as the next recommendation budget. The
        # system still waits for the user to choose a usage before building.
        if result:
            st.session_state.requirements = {"budget": int(result["total"])}
            st.session_state.pending_edit = None
            st.session_state.current_builds = []
            st.session_state.budget_reference_kind = budget_kind
        append_message("assistant", reply)
        st.rerun()

    # Short conversational commands can explicitly start/rebuild the current
    # recommendation without needing a special button.
    if build_start_command(prompt) and not st.session_state.pending_edit:
        req = st.session_state.requirements
        if req.get("budget") and usage_labels(req):
            st.session_state.pending_edit = None
            _reset_current_builds()
            reply = "ได้ครับ เดี๋ยว AI จัดชุดใหม่ตาม Requirement ปัจจุบันให้เลยครับ\n\n" + make_reply(req)
        elif req.get("budget"):
            reply = (f"รับงบ **{req['budget']:,} บาท** แล้วครับ\n\n"
                     "ก่อนเริ่มจัดชุด ขอเลือกลักษณะการใช้งานก่อนครับ แล้ว AI จะสร้าง Build 1 / Build 2 / Build 3 ให้ทันที")
        else:
            reply = "ได้ครับ บอกงบประมาณและการใช้งานก่อน เช่น **งบ 40,000 Gaming** แล้วผมจะจัดชุดให้เลยครับ"
        append_message("assistant", reply)
        st.rerun()
