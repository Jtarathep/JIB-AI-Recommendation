...
st.set_page_config(page_title="JIB AI PC Builder", page_icon="🤖", layout="wide")
st.title("🤖 JIB AI Recommendation System")
st.caption("Prototype — AI Recommendation System + Machine Learning + PC Compatibility")
...
with st.sidebar:
    st.subheader("Requirement ปัจจุบัน")
