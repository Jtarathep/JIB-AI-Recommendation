...
[data-testid="stChatMessage"] [data-testid="stChatMessageAvatarUser"] {
    ...
    border:1px solid rgba(123,150,255,.28);
...
[data-testid="stChatMessage"]:has([data-testid="stChatMessageAvatarAssistant"]) {
    ...
    border:1px solid rgba(72,126,255,.20);
    border-radius:22px;
    background:
        radial-gradient(circle at 0% 0%, rgba(0,207,255,.08), transparent 35%),
        linear-gradient(145deg, rgba(20,31,58,.82), rgba(10,17,32,.90));
    box-shadow:0 12px 35px rgba(0,0,0,.18), inset 0 1px 0 rgba(255,255,255,.035);
}

[data-testid="stChatMessage"]:has([data-testid="stChatMessageAvatarAssistant"]) [data-testid="stChatMessageAvatarAssistant"] {
    background:linear-gradient(145deg,#1b6fff,#7b4dff) !important;
    border-color:rgba(114,177,255,.5);
    box-shadow:0 0 22px rgba(77,118,255,.22);
}
...
[data-testid="stChatMessage"]:has([data-testid="stChatMessageAvatarUser"]) [data-testid="stChatMessageAvatarUser"] {
    background:linear-gradient(145deg,#5b3cff,#2f7cff) !important;
    border-color:rgba(154,137,255,.65);
    box-shadow:0 0 22px rgba(92,70,255,.24);
}
...
[data-testid="stChatMessage"]:has([data-testid="stChatMessageAvatarUser"]) [data-testid="stChatMessageContent"] {
    ...
    margin-left:auto;
    padding:.78rem 1rem;
    border:1px solid rgba(117,119,255,.28);
    border-radius:20px 20px 6px 20px;
    background:linear-gradient(135deg,rgba(77,61,185,.38),rgba(30,92,190,.28));
    box-shadow:0 10px 30px rgba(0,0,0,.16), inset 0 1px 0 rgba(255,255,255,.045);
}
...
[data-testid="stChatInput"] > div {
    border:1px solid rgba(104,130,255,.38) !important;
    border-radius:22px !important;
    background:
        linear-gradient(145deg,rgba(24,30,53,.96),rgba(13,18,33,.98)) !important;
    box-shadow:
...
[data-testid="stChatInput"] > div:focus-within {
    border-color:rgba(91,150,255,.72) !important;
    box-shadow:
        0 0 0 3px rgba(72,112,255,.10),
        0 16px 42px rgba(0,0,0,.30),
        0 0 30px rgba(72,112,255,.10);
}
...
[data-testid="stChatInput"] button {
    ...
    height:42px !important;
    border-radius:14px !important;
    border:1px solid rgba(137,145,255,.35) !important;
    background:linear-gradient(135deg,#4e55ff,#8a4dff) !important;
    color:white !important;
    box-shadow:0 6px 18px rgba(84,76,255,.24);
...
[data-testid="stChatInput"] button:hover {
    ...
    box-shadow:0 9px 24px rgba(84,76,255,.34);
}

@media (max-width: 600px) {
    [data-testid="stChatMessage"]:has([data-testid="stChatMessageAvatarUser"]) {padding-left:2%;}
    [data-testid="stChatMessage"]:has([data-testid="stChatMessageAvatarUser"]) [data-testid="stChatMessageContent"] {max-width:88%;}
}
