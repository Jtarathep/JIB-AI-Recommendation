...
<style>
    ...
    .kk-hero {
        ...
        border-radius: 18px;
        background: linear-gradient(135deg, rgba(46,125,50,.10), rgba(33,150,243,.06));
        margin-bottom: 1rem;
    }
...
<div class="kk-hero">
  ...
  <div class="kk-subtitle">Prototype — AI Recommendation System + Machine Learning + PC Compatibility</div>
  <div class="kk-badges">
    <span class="kk-badge">AI Recommendation</span>
    <span class="kk-badge">Machine Learning</span>
    <span class="kk-badge">PC Compatibility</span>
    <span class="kk-badge">JIB Case Study</span>
  </div>
</div>
